...
protected:
	unsigned _ID = -1; //! Динамический номер объекта в массиве всех объектов. НЕ ТРОГАТЬ ЕГО И НЕ МЕНЯТЬ ЕГО
	...
	GameField* gamefield = NULL; //! Указатель на игровое поле, в котором живёт данный игровой объект
