...
sf::Keyboard::Key InputManager::_keys[KeysCount]; //����� KeybordKey � SFML
KeyboardKey InputManager::_virtual_keys[255]; // ����� ����� � KeyboardKey
KeyData InputManager::_key_data[KeysCount]; //! ���������� � ��������
