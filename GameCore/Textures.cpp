...
int Textures::MENU_BUTTON = -1;

void Textures::LOAD_ALL_TEXTURES() {
	GraphicManager::SetSpritesMaxCount(7);
	...
	Textures::MENU_BUTTON = GraphicManager::LoadSprite(GraphicPrefabData("./Resources/button.png", Vector2F(410, 240), 1));
}
