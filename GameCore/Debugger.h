...
public:
	...
	static bool DrawPoint(Vector2F pos, float size, Views view_id = Views::BASIC, unsigned layer = 10);

	//! –исует белую линию между точками start и end, толщина линии thick
	static bool DrawLine(Vector2F start, Vector2F end, float thick, Views view_id = Views::BASIC, unsigned layer = 10);
