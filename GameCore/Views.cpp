...
void Views::LOAD_ALL_VIEWS() {
	...
	Views::MAIN_MENU = GraphicManager::AddView({{ 0, 0 }, cur_resolution,{ 0, 0 },{ 0, 0 },{ 1000, 1000 },{ 0, 0 },{ 1, -1 }});
	Views::PLAYER_CAM = GraphicManager::AddView({{0, 0}, cur_resolution, { 0, 0}, { 0, 0 }, { 1000, 1000 }, { 0.5, 0.5 }, { 1, -1 }});
	Views::EDITOR_CAM = GraphicManager::AddView({{0, 0}, cur_resolution, { 0, 0}, { 0, 0 }, { 1000, 1000 }, { 0.5, 0.5 }, { 1, -1 }});
}
